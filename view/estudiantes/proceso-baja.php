...
<body>
    ...
    <header>
        <section class="header-info">
            <h1 class="title-header">Proceso de <span class="text-highlight">baja</span></h1>
        </section>
    ...
    <main>
        ...
        <h3 class="primary-title">Baja temporal</h3>

        <section class="card-utl">
            <div class="left-column" id="temporal-pasos">
        ...
        <h3 class="primary-title">Baja definitiva</h3>

        <section class="card-utl">
            <div class="left-column" id="definitiva-pasos">

            </div>
            <div class="vl"></div>
            <div class="right-column" id="info">
                <ul id="definitiva-list">
                </ul>
            </div>
        </section>
