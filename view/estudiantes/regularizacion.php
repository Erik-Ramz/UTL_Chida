...
<body>
    ...
    <header>
        <section class="header-info">
            <h1 class="title-header">Proceso de <span class="text-highlight">regularización</span></h1>
        </section>
    ...
    <main>
        ...
        <h3 class="primary-title">Recuperación</h3>

        <section class="card-utl">
            <div class="left-column" id="recuperacion-pasos">

            </div>
            <div class="vl"></div>
            <div class="right-column" id="info">
                <ul id="recuperacion-list">
                </ul>
            </div>
        </section>

        <h3 class="primary-title">Extraordinario</h3>

        <section class="card-utl">
            <div class="left-column" id="extraordinario-pasos">

            </div>
            <div class="vl"></div>
            <div class="right-column" id="info">
                <ul id="extraordinario-list">
                </ul>
            </div>
        </section>
...
<script src="../js/regularizacion.js"></script>
