...
<body>
    ...
    <header>
        <section class="header-info">
            <h1 class="title-header">Proceso de <span class="text-highlight">titulación 2024</span></h1>
        </section>
    ...
    <main>
        ...
        <h3 class="primary-title">Titulación TSU</h3>

        <section class="card-utl">
            <div class="left-column" id="titulacion-tsu-pasos">

            </div>
            <div class="vl"></div>
            <div class="right-column" id="info">
                <ul id="titulacion-tsu-list">
                </ul>
            </div>
        </section>

        <h3 class="primary-title">Titulación ING/LIC</h3>

        <section class="card-utl">
            <div class="left-column" id="titulacion-ing-pasos">

            </div>
            <div class="vl"></div>
            <div class="right-column" id="info">
                <ul id="titulacion-ing-list">
                </ul>
            </div>
        </section>
